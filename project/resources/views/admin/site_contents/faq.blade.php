                    ...
                    <form action="{{route('admin.frontend.content.update',$section->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="sub_heading" class="form-control" placeholder="@langg('Service Sub Heading')" value="{{@$section->content->sub_heading}}" required>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="">@langg('Button Name')</label>
                                <input type="text" name="btn_name" class="form-control" placeholder="@langg('Button Name')" value="{{@$section->content->btn_name}}" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">@langg('Button URL')</label>
                                <input type="text" name="btn_url" class="form-control" placeholder="@langg('Button URL')" value="{{@$section->content->btn_url}}" required>
                            </div>
                        ...
                        <div class="card-body text-center">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <tr>
                                        <th>@langg('Question')</th>
                                        <th>@langg('Answer')</th>
                                        <th>@langg('Action')</th>
                                    </tr>
                                    @forelse ($section->sub_content as $key => $info)
                                        <tr>
                                            <td data-label="@langg('Question')">
                                                {{$info->question}}
                                            </td>
                                    
                                            <td data-label="@langg('Answer')">{{Str::limit($info->answer,30)}}</td>
                    ...
                    <form action="{{route('admin.frontend.sub-content.update',$section->id)}}" method="POST">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">@langg('Add FAQ Item')</h5>
            ...
            <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="modelTitleId">
                <div class="modal-dialog" role="document">
                    <form action="{{route('admin.frontend.sub-content.single.update')}}" method="POST">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">@langg('Edit FAQ Item')</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                     <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
