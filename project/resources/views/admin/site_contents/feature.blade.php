               ...
               <div class="card-body">
                    <form action="{{route('admin.frontend.content.update',$section->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="">@langg('Feature Text')</label>
                                <input type="text" name="feature_text" class="form-control" placeholder="@langg('Feature Text')" value="{{@$section->content->feature_text}}" required>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    @forelse ($section->sub_content as $key => $info)
                                        <tr>
                                           <td>{{++$i}}</td>
                                            <td data-label="@langg('Feature')">{{$info->feature}}</td>
