      ...
      <div class="card-body">
        ...
        <form method="POST" action="" class="needs-validation">
            @csrf
                ...
                <div class="form-group">
                    <label for="password" class="control-label">@langg('New Password')</label>
                ...
                <div class="form-group">
                    <label for="password" class="control-label">@langg('Confirm Password')</label>
