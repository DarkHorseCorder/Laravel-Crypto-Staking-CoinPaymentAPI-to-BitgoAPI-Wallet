                ...
                <div class="dashboard-card">
                    <div class="dashboard-card__header">
                        ...
                        <div class="dashboard-card__header__cont">
                            ...
                            <div class="balance"><?php echo e(numFormat($wallet->balance * $wallet->curr->rate,8)); ?> <?php echo e($gs->curr_code); ?></div>
                        </div>
                    </div>
                </div>
                <div class="dashboard-card">
                        ...
                        <form class="create-offer-form" method="POST" action="<?php echo e(route('user.withdraw.submit')); ?>">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <p class="mt-3"><span class="text-danger"><?php echo translate('Please Note'); ?></span> : <?php echo translate('Once you Submit your transaction, This action cannot be undone or refunded. Please double check your Send To Address'); ?>.</p>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\custom\exchange\project\resources\views/user/withdraw/withdraw_form.blade.php ENDPATH**/ ?>