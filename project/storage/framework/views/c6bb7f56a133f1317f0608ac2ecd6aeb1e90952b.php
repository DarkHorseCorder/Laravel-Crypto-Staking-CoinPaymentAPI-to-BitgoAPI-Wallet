                  ...
                  <ul class="nav-menu">
                    ...
                    <li>
                        ...
                        <div class="btn__grp ms-lg-3">
                            <a href="<?php echo e(route('user.dashboard')); ?>" class="cmn--btn"><?php echo app('translator')->get('User Dashboard'); ?></a>
                            <a href="<?php echo e(route('user.logout')); ?>" class="cmn--btn btn-outline"><?php echo app('translator')->get('Logout'); ?></a>
                        </div>
                        <?php else: ?>
                        <div class="btn__grp ms-lg-3">
                            <a href="<?php echo e(route('user.login')); ?>" class="cmn--btn"><?php echo app('translator')->get('Sign in'); ?></a>
...
</header><?php /**PATH C:\xampp\htdocs\custom\exchange\project\resources\views/frontend/partials/header.blade.php ENDPATH**/ ?>