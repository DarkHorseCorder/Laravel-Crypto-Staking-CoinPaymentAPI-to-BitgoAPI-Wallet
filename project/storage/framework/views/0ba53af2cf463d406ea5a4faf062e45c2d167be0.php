            ...
            <div class="dashboard-card">
                <div class="dashboard-card__header">
                    ...
                    <div class="dashboard-card__header__cont">
                        ...
                        <div class="balance"><?php echo e(numFormat($item->balance*$item->curr->rate,8)); ?> <?php echo e($gs->curr_code); ?></div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\custom\exchange\project\resources\views/user/dashboard.blade.php ENDPATH**/ ?>